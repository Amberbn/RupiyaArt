                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box p-l-20 p-r-20">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{route('saveProduct')}}" class="floating-labels" method="post">
                                      {{ csrf_field() }}
                                        <div class="form-group m-b-40">
                                            <input type="text" class="form-control" id="name_product" name="name_product"><span class="highlight"></span> <span class="bar"></span>
                                        ...
                                        <div class="form-group m-b-5">
                                            <textarea class="form-control" rows="4" id="description" name="description"></textarea><span class="highlight"></span> <span class="bar"></span>
